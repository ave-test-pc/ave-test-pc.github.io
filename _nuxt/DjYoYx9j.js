 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */,y=(t,r)=>{var e;const a=t._$AN;if(void 0===a)return!1;for(const o of a)null==(e=o._$AO)||e.call(o,r,!1),y(o,r);return!0},S=t=>{let r,e;do{if(void 0===(r=t._$AM))break;e=r._$AN,e.delete(t),t=r}while(0===(null==e?void 0:e.size))},E=t=>{for(let r;r=t._$AM;t=r){let e=r._$AN;if(void 0===e)r._$AN=e=new Set;else if(e.has(t))break;e.add(t),x(r)}};function b(t){void 0!==this._$AN?(S(this),this._$AM=t,E(this)):this._$AM=t}function $(t,r=!1,e=0){const a=this._$AH,o=this._$AN;if(void 0!==o&&0!==o.size)if(r)if(Array.isArray(a))for(let i=e;i<a.length;i++)y(a[i],!1),S(a[i]);else null!=a&&(y(a,!1),S(a));else y(this,t)}const x=t=>{t.type==s.CHILD&&(t._$AP??(t._$AP=$),t._$AQ??(t._$AQ=b))};class R extends n{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,r,e){super._$AT(t,r,e),E(this),this.isConnected=t._$AU}_$AO(t,r=!0){var e,a;t!==this.isConnected&&(this.isConnected=t,t?null==(e=this.reconnected)||e.call(this):null==(a=this.disconnected)||a.call(this)),r&&(y(this,t),S(this))}setValue(t){if(void 0===this._$Ct.strings)this._$Ct._$AI(t,this);else{const r=[...this._$Ct._$AH];r[this._$Ci]=t,this._$Ct._$AI(r,this,0)}}disconnected(){}reconnected(){}}
/**
 * @license
...
`;var X=function(t,r,e,a){var o,i=arguments.length,n=i<3?r:null===a?a=Object.getOwnPropertyDescriptor(r,e):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,r,e,a);else for(var s=t.length-1;s>=0;s--)(o=t[s])&&(n=(i<3?o(n):i>3?o(r,e,n):o(r,e))||n);return i>3&&n&&Object.defineProperty(r,e,n),n};let Z=class extends r{constructor(){super(...arguments),this.color="accent-100",this.size="lg"}render(){return this.style.cssText="--local-color: "+("inherit"===this.color?"inherit":`var(--wui-color-${this.color})`),this.dataset.size=this.size,e`<svg viewBox="25 25 50 50">
    ...
    </svg>`}};Z.styles=[g,K],X([i()],Z.prototype,"color",void 0),X([i()],Z.prototype,"size",void 0),Z=X([w("wui-loading-spinner")],Z);export{v as U,w as c,R as f,f as o};
